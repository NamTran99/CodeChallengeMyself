//package com.example.ads.activity.format.custom
//
...
//
//
//object IKBannerCollapseInlineController : IKSdkBaseAdController() {
//    private const val TAG_LOG = "IKBannerCollapseInlineController"
//
//    override val admob: BannerInlineAdmob by lazy {
//        BannerInlineAdmob().apply {
//            adFormatName = IKSdkDefConst.AdFormat.BANNER_COLLAPSE_C1_IL
//        }
//    }
//
//    override val adGam: BannerInlineGam by lazy {
//        BannerInlineGam().apply {
//            adFormatName = IKSdkDefConst.AdFormat.BANNER_COLLAPSE_C1_IL
//        }
//    }
...
//        get() = null
//
//    override suspend fun getBackupAd(): IKAdapterDto? =
//        IKDataCoreManager.getBackupBannerCollapseInline()
//
//    override val adFormat: IKAdFormat = IKAdFormat.BANNER_COLLAPSE_C1_IL
//
...
////                    break
////                if (adData.adSizeDto == adSize
////                    || adData.adSizeDto == null
...
//        repeat(4) {
//            IKDataRepository.getInstance().getSDKBannerCollapseCustom()?.let { dto ->
//                runCatching {
//                    mAdDto = dto.copy()
//                    val findData = dto?.adapters?.filter {
//                        it.customTag == "inline"
//                    } ?: listOf()
//                    mAdDto?.adapters = ArrayList(findData)
//                }.onFailure {
//                    mAdDto = dto.copy()
//                }
//                return mAdDto
