...
class BannerInlineAdmob : BannerAdmob() {
    ...
    private suspend fun BannerInlineAdmob.getAdSize(
        screen: String?,
        context: Context
    ): AdSize {
...
//                        val (_, density) = calculatorAdSize(context)
//                        if (density == 0f) return@runCatching AdSize.MEDIUM_RECTANGLE
//                        val adWidth = (viewWidth / density).toInt()
//                        val adHeight = (viewHeight / density).toInt()
//                        AdSize.getInlineAdaptiveBannerAdSize(adWidth, adHeight)
//                    }.getOrNull() ?: adaptiveSize(context)
//                }
//
...
//                    if (viewWidth == 0)
//                        return adaptiveSize(context)
//                    return adaptiveSize(context, viewWidth)
//                }
