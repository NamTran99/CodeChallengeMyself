...
object IKNativeCollapseNativeController : IKSdkBaseAdController() {

    private const val TAG_LOG = "IKNativeCollapseNativeController"

    override val adMax: NativeMAX? by lazy {
        if (IKApplovinHelper.isInitialized())
            NativeMAX().apply {
                adFormatName = IKSdkDefConst.AdFormat.BANNER_COLLAPSE_C2
            }
        else null
    }
    ...
    override val adFormat: IKAdFormat = IKAdFormat.BANNER_COLLAPSE_C2
