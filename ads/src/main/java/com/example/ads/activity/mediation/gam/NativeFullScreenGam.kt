...
open class NativeFullScreenGam : IKSdkBaseNativeFullScreenAdGoogle(AdNetwork.AD_MANAGER) {
        ...
        var loadCoreCallback: IKSdkLoadCoreAdCallback<NativeAd>? =
            object : IKSdkLoadCoreAdCallback<NativeAd> {
                ...
                override fun onLoadFail(error: IKAdError) {
                    handleTimeout?.onLoadFail(this@NativeFullScreenGam, error, scriptName)
                    handleTimeout = null
                }
            }
