...
class NativeGam :
    IKSdkBaseNativeAds<NativeAd>(AdNetwork.AD_MANAGER) {
        ...
        var loadCoreCallback: IKSdkLoadCoreAdCallback<NativeAd>? =
            object : IKSdkLoadCoreAdCallback<NativeAd> {
                override fun onLoaded(result: NativeAd) {
                    ...
                    handleTimeout?.onLoaded(this@NativeGam, coroutineScope, objectAd, scriptName)
                    handleTimeout = null
                ...
                override fun onLoadFail(error: IKAdError) {
                    handleTimeout?.onLoadFail(this@NativeGam, error, scriptName)
                    handleTimeout = null
                }
            }
...
//        adLoader.loadAd(AdManagerAdRequest.Builder().build())
    ...
    private fun NativeAd?.setupOnPaidEventListener(adUnitId: String, screen: String) =
        OnPaidEventListener {
