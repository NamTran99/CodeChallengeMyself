...
//
//
//object IKBannerCollapseBannerController : IKSdkBaseAdController() {
//    private const val TAG_LOG = "IKBannerCollapseBannerController"
//    override val adMax: BannerAdMax? by lazy {
//        if (IKApplovinHelper.isInitialized())
//            BannerAdMax().apply {
//                adFormatName = IKSdkDefConst.AdFormat.BANNER_COLLAPSE_C1_BN
//            }
//        else null
//    }
//
...
//        IKDataCoreManager.getBackupBannerCollapseBanner()
//
//    override val adFormat: IKAdFormat = IKAdFormat.BANNER_COLLAPSE_C1_BN
//
