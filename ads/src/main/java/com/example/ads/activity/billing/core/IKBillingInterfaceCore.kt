...
interface IKBillingInterfaceCore {
    fun initBilling(context: Context, provider: SDKIAPProductIDProvider?, callback: IKBillingInitialListener?)
    ...
    suspend fun getListConfigData(screen: String): String?
}