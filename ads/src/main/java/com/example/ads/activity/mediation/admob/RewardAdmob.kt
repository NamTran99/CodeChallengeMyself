...
class RewardAdmob : IKSdkBaseRewardAd<RewardedAd>(AdNetwork.AD_MOB) {
    ...
    override suspend fun loadCoreAd(
        ...
        var objectAd: IKSdkBaseLoadedAd<RewardedAd>?
        val callbackLoad = object : RewardedAdLoadCallback() {

            override fun onAdFailedToLoad(p0: LoadAdError) {
                super.onAdFailedToLoad(p0)
                showLogD("loadCoreAd onAdFailedToLoad, $p0")
                handleTimeout?.onLoadFail(this@RewardAdmob, IKAdError(p0), scriptName)
                handleTimeout = null
            }
            ...
            override fun onAdLoaded(p0: RewardedAd) {
                ...
                handleTimeout?.onLoaded(this@RewardAdmob, coroutineScope, objectAd, scriptName)
                handleTimeout = null
            }
        }
