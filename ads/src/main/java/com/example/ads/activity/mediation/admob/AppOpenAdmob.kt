...
class AppOpenAdmob : IKSdkBaseAppOpenAd<AppOpenAd>(AdNetwork.AD_MOB) {
...
//            }
            ...
            adReady.loadedAd?.onPaidEventListener = setupOnPaidEventListener(
                adReady.loadedAd,
                screen
            )
    ...
    override suspend fun loadCoreAd(
        ...
        val callbackLoad = object : AppOpenAd.AppOpenAdLoadCallback() {
            ...
            override fun onAdFailedToLoad(p0: LoadAdError) {
                ...
                handleTimeout?.onLoadFail(this@AppOpenAdmob, IKAdError(p0), scriptName)
                handleTimeout = null
            }
            ...
            override fun onAdLoaded(p0: AppOpenAd) {
                ...
                handleTimeout?.onLoaded(this@AppOpenAdmob, coroutineScope, objectAd, scriptName)
                handleTimeout = null
            }
        }
